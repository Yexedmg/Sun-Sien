...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const SHARED_COPY = globalThis.SUN_SIEN_COPY ?? {
    callWaitNote: {
      nl: 'Let op!! Telefonisch bestelling duurt minimaal een uur, wilt u niet zo lang wachten, dan kunt u in de winkel inlopen zonder te bellen , daar wordt je sneller geholpen.',
      en: 'Please note!! Orders placed by phone take at least an hour. If you don\'t want to wait that long, you can come into the store without calling, and you\'ll be able to order sooner.',
    },
  };
  ...
  const TRANSLATIONS = {
    nl: {
      ...
      'status.openUntil': 'Nu Open · Tot {time}',
      ...
      'faq.queueAnswer': 'Ja. Bestellingen via telefoon en en mensen die bestelling aan de balie doen sluiten zich aan te sluiten in dezelfde rij',

      'faq.phoneQuestion': 'Kan ik telefonisch bestellen?',
      'faq.phoneAnswer': 'Telefonisch bestelling duurt minimaal een uur, wilt u niet zo lang wachten, dan kunt u in de winkel inlopen zonder te bellen , daar wordt je sneller geholpen!',
      ...
      'list.noticeBody': 'Stel hier je bestelling samen! We accepteren momenteel geen online betalingen.',
